        ...
        <div class="col-6">
            <div class="card">
                        ...
                        foreach ($data['view'] as $col) {
                            ...
                            <form action="index.php?action=edit_form" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id" value="<?php echo $col['id']; ?>" style="display:none">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="sex" <?php if ($col['sex'] == "Male") { ?> checked="checked" <?php } ?> value="Male">Male <br>
                ...
                <div class="card-footer">
                    ...
                    <input type="submit" class="btn btn-primary float-right" name="edit" value="Submit">
                </div>
                <?php
                     }
                 }
